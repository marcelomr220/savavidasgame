...
import AdminInvestigation from './components/AdminInvestigation';
              ...
              <Routes location={location}>
                ...
                {isAdmin && (
                  <>
                    ...
                    <Route path="/admin/investigation" element={<AdminInvestigation />} />
                    <Route path="/admin/presence-confirmation" element={<PresenceConfirmation />} />
                  </>
                )}
              </Routes>
            </motion.div>
