  ...
  const handleOpenModal = (team?: Team) => {
    if (team) {
      ...
      setFormData({
        ...
        monitor_id: team.monitor_id?.toString() || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const teamData = {
        ...
        monitor_id: formData.monitor_id ? parseInt(formData.monitor_id) : null
      };
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-stone-700 mb-1">Monitor da Equipe</label>
                    <select
