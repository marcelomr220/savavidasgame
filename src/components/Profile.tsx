...
export default function Profile({ user, onUpdateUser }: { user: User, onUpdateUser: (user: User) => void }) {
  ...
  const getMascotMessage = (status: string) => {
    if (status === 'critical') return "ESTOU QUASE APAGANDO!";
    if (status === 'sad') return "Senti sua falta!";
    if (status === 'neutral') return "Que bom ver você!";
    return "Seu perfil está top!";
  };
        ...
        <div className="px-6 pb-6">
            <div className="relative -mt-12 mb-4 flex items-end justify-between">
              <div className="flex items-end gap-4">
                ...
                <div className="hidden sm:flex flex-col items-center gap-1 mb-2">
                  <Mascot 
                    size="sm" 
                    ...
                    status={mascotStatus} 
                  />
                  <span className="px-2 py-0.5 bg-red-50 text-red-600 text-[8px] font-black rounded-full uppercase tracking-widest border border-red-100">
