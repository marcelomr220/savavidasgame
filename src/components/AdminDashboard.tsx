...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    getAdminStats()
      .then(data => setStats(data || { totalUsers: 0, activeTeams: 0, pendingTasks: 0 }))
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <section className="bg-white p-6 rounded-3xl border border-stone-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <AdminLink to="/admin/presence-confirmation" icon={UserCheck} title="Confirmação de Presença" desc="Marcar presença por equipe" />
            ...
            <AdminLink to="/admin/investigation" icon={Search} title="Investigação" desc="Gerenciar casos e pistas" />
