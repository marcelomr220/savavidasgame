...
-- NOTE: If you are using a custom login (not Supabase Auth), auth.uid() will be null.
-- To allow the anon key to read tasks, use 'true' instead of 'is_active = true' for testing,
-- or ensure that the anon key has permission to read.
